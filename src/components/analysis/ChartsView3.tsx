...
export default function ChartsView() {
    ...
    const bonusBallChartData = useMemo(() => {
        const frequency = calculateBonusBallFrequency(draws);
    ...
    const advancedStats = useMemo(() => {
        ...
        return calculateAdvancedStats(draws);
    ...
    const hotColdAnalysis = useMemo(() => {
        const recentDraws = draws.slice(-30); // Last 30 draws
    ...
    return (
        <>
            <ScrollView style={styles.container}>
                ...
                {/* Hot/Cold Numbers */}
                <Card style={styles.card}>
                    <Card.Title title="🔥❄️ Hot & Cold Numbers (Last 30 Draws)" />
                    <Card.Content>
